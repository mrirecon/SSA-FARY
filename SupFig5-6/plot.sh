...
#--- Process Images ---
# Diastole
python3 ../utils/figcreator.py -t "LCv:end-systole" _endsys_endinh.png _endsys_inh1.png
python3  ../utils/figcreator.py --tile 1x3 _endsys_inh1.png _endsys_inter.png _endsys_endexh.png _sys.png

# Systole
python3 ../utils/figcreator.py -t "TCh:end-expiration" _enddia_endexh.png _enddia_exh1.png
python3 ../utils/figcreator.py -t "TCh: " _enddia_inter.png _enddia_inter1.png
python3 ../utils/figcreator.py -t "TCh:end-inspiration" _enddia_endinh.png _enddia_inh1.png

python3 ../utils/figcreator.py -t "LCv:end-diastole    " _enddia_inh1.png _enddia_inh2.png
python3  ../utils/figcreator.py --tile 1x3 _enddia_inh2.png _enddia_inter1.png _enddia_exh1.png _dia.png


# Tile
python3  ../utils/figcreator.py --spacing 20 --tile 2x1 _dia.png _sys.png _c1.png
...
python3 ../utils/figcreator.py --tile 3x1 _{a,b,c}.png SupFig6_SS.png

#--- AC region ---
python3 ../utils/figcreator.py -t "LCv:Coils" SupFig5a_AC.png _a0.png
python3 ../utils/figcreator.py -t "BCh:Time →" _a0.png _a1.png
python3 ../utils/figcreator.py -t "LTh:a)" _a1.png _a.png

python3 ../utils/figcreator.py -t "LCv:Coils" SupFig5b_AC-corr.png _b0.png
