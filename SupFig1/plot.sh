...
#
# Script to reproduce SupFig1 of the followin manuscript:
#
# Rosenzweig S et al.
...
# Join
python3 ../ssa_fary_utils/figcreator.py --tile "4x1" --spacing 100 _a.png _b.png _c.png _d.png SupFig1_AmpVar.png
