...
#--- Images ---
# Diastole
python3 ../ssa_fary_utils/figcreator.py -t "LCv:end-systole" _endsys_endexh.png _endsys_endexh1.png
python3  ../ssa_fary_utils/figcreator.py --tile 1x3  _endsys_endexh1.png _endsys_endinh.png  CINE/slice_06-1_frame11_endsys.jpg _sys.png

# Itermediate
python3 ../ssa_fary_utils/figcreator.py -t "LCv: " _inter_endexh.png _inter_endexh1.png
python3  ../ssa_fary_utils/figcreator.py --tile 1x3 _inter_endexh1.png _inter_endinh.png  CINE/slice_06-1_frame14_inter.jpg _inter.png

# Systole
python3 ../ssa_fary_utils/figcreator.py -t "TCh:SSA-FARY end-expiration" _enddia_endexh.png _enddia_exh1.png
python3 ../ssa_fary_utils/figcreator.py -t "TCh:SSA-FARY end-inspiration" _enddia_endinh.png _enddia_inh1.png
python3 ../ssa_fary_utils/figcreator.py -t "TCh:ECG-CINE" CINE/slice_06-1_frame23_enddia.jpg _enddia_cine.png

python3 ../ssa_fary_utils/figcreator.py -t "LCv:end-diastole    " _enddia_exh1.png _enddia_exh2.png
python3  ../ssa_fary_utils/figcreator.py --tile 1x3 _enddia_exh2.png _enddia_inh1.png  _enddia_cine.png _dia.png
...
python3 ../ssa_fary_utils/figcreator.py --tile 3x1 --spacing 40 _{a,b,c}.png Fig4_SS.png

#--- AC region ---
python3 ../ssa_fary_utils/figcreator.py -t "LCv:Coils" Fig3a_AC.png _a0.png
python3 ../ssa_fary_utils/figcreator.py -t "BCh:Time →" _a0.png _a1.png
python3 ../ssa_fary_utils/figcreator.py -t "LTh:a)" _a1.png _a.png

python3 ../ssa_fary_utils/figcreator.py -t "LCv:Coils" Fig3b_AC-corr.png _b0.png
