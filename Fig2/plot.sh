...
function plot {
	...
	echo "echo: " $K
 	...
 	S="S_"$1
 	U="U_"$1
 	python3 plot_data.py --ylim $ylim --y2lim $y2lim -x $interval --eof $eof $K $S $EOF $U osc_sin1 osc_sin2 $1
}
...
eof="0:1:2:3"
for type in "noise" "spell" "sin"; do
	plot $type
done
...
# Join
python3 ../ssa_fary_utils/figcreator.py --tile "4x1" --spacing 100 _a.png _b.png _c.png _d.png Fig2.png
