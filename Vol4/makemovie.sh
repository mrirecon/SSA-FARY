...
for Rstate in 2; do
	...
	cfl2png -F Y -u0.35 _c SoS_R${Rstate}
done

for Rstate in 2; do
	for i in {0000..0024}; do

		python3 ../utils/figcreator.py --tile 1x6 SoS_R${Rstate}_frame_${i}_u_000{5,4,3,2,1,0}.png SoS_R${Rstate}_${i}.png
	done
done


ffmpeg -r 25 -f image2 -i SoS_R${Rstate}_%4d.png -b 9000k -vcodec wmv2 -pix_fmt yuv420p Mov11_SoS_V4.wmv
