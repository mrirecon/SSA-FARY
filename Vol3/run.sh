...
#
# Script to reproduce Volunteer V3 of the following manuscript:
#
# Rosenzweig S et al.
...
rm pat*.{cfl,hdr} sens*.{cfl,hdr} t*.{cfl,hdr} k*.{cfl,hdr} rec1*.{cfl,hdr} eof.{cfl,hdr}
